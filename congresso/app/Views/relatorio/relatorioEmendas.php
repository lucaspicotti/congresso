<div class="d-flex flex-column justify-content-center align-items-center">
    ...
    <div class="ps-3 pt-2 pe-2 titulo bg-gradient rounded-top shadow-sm">
        <h3>Relatório de emendas</h3>
    </div>

    <div class="formulario row border rounded-bottom p-3 shadow-sm ms-10">

        <?php echo form_open('relatorio/emendasResultado', ['class' => 'row']);?>
            ...
            <div class="col-md-3 p-2">
                <label for="tese_guia" class="form-label">Incluir tese guia?:</label>
                <select id="tese_guia" name="tese_guia" class="form-select">
