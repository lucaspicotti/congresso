...
<body>
  ...
  <header class="mb-5">
    <nav class="navbar bg-gradient shadow-sm" style="background-color: #0aa2d8!important;">
        ...
        <ul class="nav justify-content-end-md">
          ...
          <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
              <li><a class="dropdown-item" href="#">Incluir caderno</a></li>
              <li><a class="dropdown-item" href="#">Editar caderno</a></li>
            </ul>
          </li>

          <li class="nav-item">
            <a class="nav-link link-light active" aria-current="page" href="<?php echo base_url('emendas');?>">Emendas</a>
          </li>

          <li class="nav-item">
            <a class="nav-link link-light active" aria-current="page" href="#">Relatório</a>
          </li>
